...
export class DbInit1734175400988 implements MigrationInterface {
    name = 'DbInit1734175400988'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order-products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL DEFAULT '1', "product_id" uuid, "order_id" uuid, CONSTRAINT "UQ_bdc0068a0d52153034882d60d31" UNIQUE ("order_id", "product_id"), CONSTRAINT "PK_24016ece7c077d34c9fd8bff952" PRIMARY KEY ("id"))`);
