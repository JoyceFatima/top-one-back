...
export class DbInit1734352094774 implements MigrationInterface {
    name = 'DbInit1734352094774'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order_products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL DEFAULT '1', "product_id" uuid, "order_id" uuid, CONSTRAINT "UQ_df651f408724961907ab06672fa" UNIQUE ("order_id", "product_id"), CONSTRAINT "PK_3e59f094c2dc3310d585216a813" PRIMARY KEY ("id"))`);
